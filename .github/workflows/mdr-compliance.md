...
- Use the **Remediation pull request template**. Fill in the vibe-coding disclosure that
  `CONTRIBUTING.md` requires: the code was generated by GitHub Copilot through the MDR
...
- Vibe coded: yes. Generated by GitHub Copilot via the MDR Compliance Agent workflow
